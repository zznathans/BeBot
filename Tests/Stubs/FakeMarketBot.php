...
timer registration) and watch()/announce_tracked()'s send_pgroup() calls to
run without a real AO/AoC connection or database. Every module-instantiation
call this bot doesn't specifically need to observe is swallowed by
FakeNoOpCore.
*/
class FakeMarketBot
{
